...
class IPV_Prod_Video_Frontend {
    ...
    public static function prepend_youtube_embed( $content ) {
        ...
        // CSS inline con alta specificità per evitare conflitti con il tema
        $embed_html = '
        <style>
        ...
        .ipv-video-embed-container .ipv-embed-wrapper {
        ...
        .ipv-video-embed-container .ipv-embed-wrapper iframe {
