...
class IPV_Prod_Bulk_Import {
    ...
    public static function render_page() {
        ...
        <div class="wrap ipv-prod-wrap">
            ...
            <?php if ( empty( $youtube_key ) && ! IPV_Prod_API_Client_Optimized::is_license_active() ) : ?>
                <div class="alert alert-warning">
                    <i class="bi bi-exclamation-triangle-fill me-2"></i>
                    <strong>Licenza non attiva.</strong>
                    <a href="<?php echo esc_url( admin_url( 'edit.php?post_type=ipv_video&page=ipv-production-license' ) ); ?>">Attiva la licenza</a> per usare questa funzionalità.
                </div>
            <?php elseif ( empty( $youtube_key ) ) : ?>
                <div class="alert alert-info">
                    <i class="bi bi-info-circle-fill me-2"></i>
                    <strong>Funzionalità opzionale:</strong>
                    Import canale disponibile configurando una YouTube API key in <a href="<?php echo esc_url( admin_url( 'edit.php?post_type=ipv_video&page=ipv-settings' ) ); ?>">Impostazioni → Server</a>.
                </div>
            <?php else : ?>
