...
class IPV_Prod_License_Manager_Client {
    ...
    public static function init() {
        // v1.0.3 - Menu registration handled by Menu Manager (removed duplicate)
                                ...
                                <div class="space-y-4">
                                    <div>
                                        ...
                                        <input type="text"
                                               ...
                                               pattern="(IPV-)?[A-Za-z0-9]{4,5}(-[A-Za-z0-9]{4,5}){2,5}"
                                               title="Formato: XXXXX-XXXXX-XXXXX o IPV-XXXXX-XXXXX-XXXXX-XXXXX"
                                               required>
                    ...
                    <div class="ipv-card bg-blue-50 border-blue-200">
                        <div class="p-6">
                            <h3 class="text-xl font-bold text-gray-900 mb-4 flex items-center gap-2">
                                <svg width="24" height="24" class="w-6 h-6 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <ul class="space-y-2">
                                <li class="flex items-center gap-2 text-gray-700">
                                    <svg width="20" height="20" class="w-5 h-5 text-green-600 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
