...
class IPV_Prod_Language_Manager {
    ...
    public static function render_page() {
        ...
        <div class="wrap ipv-prod-wrap">
            ...
            <ul class="nav nav-tabs mb-4" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo esc_url( admin_url( 'edit.php?post_type=ipv_video&page=ipv-production-rss' ) ); ?>">
                        <i class="bi bi-rss me-1"></i><?php esc_html_e( 'Auto-Import RSS', 'ipv-production-system-pro' ); ?>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo esc_url( admin_url( 'edit.php?post_type=ipv_video&page=ipv-production-queue' ) ); ?>">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="<?php echo esc_url( admin_url( 'edit.php?post_type=ipv_video&page=ipv-production-language' ) ); ?>">
            ...
            <ul class="nav nav-pills mb-4">
                <li class="nav-item">
                    <a class="nav-link <?php echo $active_tab === 'settings' ? 'active' : ''; ?>" 
                       href="<?php echo esc_url( admin_url( 'edit.php?post_type=ipv_video&page=ipv-production-language&tab=settings' ) ); ?>">
                ...
                <li class="nav-item">
                    <a class="nav-link <?php echo $active_tab === 'editor' ? 'active' : ''; ?>" 
                       href="<?php echo esc_url( admin_url( 'edit.php?post_type=ipv_video&page=ipv-production-language&tab=editor' ) ); ?>">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="<?php echo esc_url( admin_url( 'edit.php?post_type=ipv_video&page=ipv-production-language&tab=editor&locale=' . $locale ) ); ?>" class="btn btn-sm btn-outline-primary"><i class="bi bi-pencil"></i></a>
                                        <?php endif; ?>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
    ...
    private static function render_editor_tab( $translations_status ) {
        ...
        jQuery(document).ready(function($) {
            ...
            $('#ipv-po-locale').on('change', function() { window.location.href = '<?php echo admin_url( 'edit.php?post_type=ipv_video&page=ipv-production-language&tab=editor&locale=' ); ?>' + $(this).val(); });
