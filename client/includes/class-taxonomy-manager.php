    ...
    public static function render_page() {
        ...
        <div class="wrap ipv-prod-wrap">
            ...
            <ul class="nav nav-tabs mb-4" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="<?php echo esc_url( admin_url( 'edit.php?post_type=ipv_video&page=ipv-production-taxonomies' ) ); ?>">
            ...
            <div class="card shadow-sm mt-4">
                ...
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-3">
                            <a href="<?php echo esc_url( admin_url( 'edit.php?post_type=ipv_video&page=ipv-import' ) ); ?>" class="btn btn-outline-warning w-100">
                                <i class="bi bi-cloud-download me-1"></i>
                                <?php esc_html_e( 'Import Video', 'ipv-production-system-pro' ); ?>
                            </a>
                        </div>
                        <div class="col-md-3">
                            <a href="<?php echo esc_url( admin_url( 'edit.php?post_type=ipv_video&page=ipv-production-bulk' ) ); ?>" class="btn btn-outline-secondary w-100">
