<?php
/**
 * IPV YouTube Importer - Admin page for video import
 * 
 * @version 9.1.0
 * CHANGELOG v9.1.0:
...
class IPV_Prod_YouTube_Importer {
    ...
    public static function render_page() {
        ...
        <div class="wrap ipv-prod-wrap">
            ...
            <ul class="nav nav-tabs mb-4" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="<?php echo esc_url( admin_url( 'edit.php?post_type=ipv_video&page=ipv-import' ) ); ?>">
                ...
                <div class="col-lg-5">
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <p class="text-muted mb-0 small">
                                            <?php esc_html_e( 'Video data and thumbnail are fetched from YouTube', 'ipv-production-system-pro' ); ?>
                                        </p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card shadow-sm mt-4">
                        ...
                        <div class="card-footer bg-light text-center">
                            <a href="<?php echo esc_url( admin_url( 'edit.php?post_type=ipv_video&page=ipv-production-queue' ) ); ?>" class="btn btn-sm btn-outline-secondary">
    ...
    public static function handle_form_submit() {
        ...
        if ( empty( $url ) ) {
            self::redirect_with_error( __( 'URL missing.', 'ipv-production-system-pro' ) );
        }

        // Usa helper centralizzato
        $video_id = IPV_Prod_Helpers::extract_youtube_id( $url );
        if ( ! $video_id ) {
            self::redirect_with_error( __( 'Could not extract Video ID from the provided URL.', 'ipv-production-system-pro' ) );
        }
