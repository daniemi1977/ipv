...
class IPV_Prod_Video_List_Columns {
    ...
    public static function add_row_actions( $actions, $post ) {
        ...
        if ( ! empty( $transcript ) && current_user_can( 'edit_post', $post->ID ) ) {
            ...
            $actions['download_transcript'] = sprintf(
                ...
                esc_attr__( 'Download transcript as TXT file', 'ipv-production-system-pro' ),
                esc_html__( 'Download Transcript', 'ipv-production-system-pro' )
            );
        }
