...
class IPV_Vendor_WooCommerce_Integration {
    ...
    public function add_product_fields() {
        ...
        woocommerce_wp_select([
            ...
            'options' => [
                'trial' => 'Trial (10 video/anno)',
                'starter' => 'Starter (25 video/mese)',
                'professional' => 'Professional (100 video/mese)',
                'business' => 'Business (500 video/mese)'
            ],
            'desc_tip' => true,
            'description' => __( 'Seleziona il piano IPV Pro corrispondente', 'ipv-pro-vendor' )
        ]);

        // Credits total
        woocommerce_wp_number([
            'id' => '_ipv_credits_total',
            'label' => __( 'Crediti Mensili', 'ipv-pro-vendor' ),
            'desc_tip' => true,
            'description' => __( 'Numero di video importabili al mese', 'ipv-pro-vendor' ),
            'type' => 'number',
            'custom_attributes' => [
                'step' => '1',
                'min' => '0'
        ...
        woocommerce_wp_number([
            ...
            'value' => get_post_meta( $post->ID, '_ipv_activation_limit', true ) ?: 1
        ]);
