...
class IPV_Vendor_License_Manager {
    ...
    public function create_license_from_order( $order_id, $product_id ) {
        ...
        // Get plan details from product meta
        $variant_slug = get_post_meta( $product_id, '_ipv_plan_slug', true ) ?: 'trial';
        $credits_total = get_post_meta( $product_id, '_ipv_credits_total', true ) ?: 10;
        $activation_limit = get_post_meta( $product_id, '_ipv_activation_limit', true ) ?: 1;
    ...
    private function send_license_email( $order, $license_key ) {
        ...
        <body style='font-family: Arial, sans-serif; line-height: 1.6; color: #333;'>
            <div style='max-width: 600px; margin: 0 auto; padding: 20px;'>
                ...
                <p>Email: <a href='mailto:support@ilpuntodivista.com'>support@ilpuntodivista.com</a></p>
