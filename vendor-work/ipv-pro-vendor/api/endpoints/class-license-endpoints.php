...
class IPV_Vendor_License_Endpoints {
    ...
    public function activate_license( $request ) {
        try {
            ...
            // v1.0.19 - Push server_url al client (architettura SaaS)
            return rest_ensure_response([
                ...
                'server_url' => home_url(),
                'api_base' => home_url( '/wp-json/ipv-vendor/v1' )
            ]);
    ...
    public function validate_license( $request ) {
        ...
        // v1.0.22 - Passa il site_url per validazione dominio
        $result = $license_manager->validate( $license_key, $site_url );
