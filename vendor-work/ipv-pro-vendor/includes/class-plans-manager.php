...
class IPV_Vendor_Plans_Manager {
    ...
    /**
     * Get default plans
     * v1.0.16 - TUTTI I PIANI ANNUALI (mensile × 11 = 1 mese gratis)
     * 
     * PRODOTTI TOTALI: 7
     * - 4 piani annuali (Trial, Starter, Professional, Business)
     * - 1 Golden Prompt (annuale)
     * - 2 pacchetti crediti extra (10 e 100)
     */
    public function get_default_plans() {
        return [
            // ========================================
            // PIANO 1: TRIAL (gratuito, una tantum)
            // ========================================
            'trial' => [
                'name' => 'Trial',
                'slug' => 'trial',
            ...
            // ========================================
            // PIANO 2: STARTER ANNUALE
            // Mensile: 9.99€ × 11 = 109.89€ → 109€/anno
            // Crediti: 50/mese × 12 = 600/anno
            // ========================================
            'starter' => [
                'name' => 'Starter',
                'slug' => 'starter',
                'credits' => 600, // 50/mese × 12 mesi
                'credits_period' => 'year',
                'activations' => 1,
                'price' => 109.00, // 9.99 × 11 = 109.89 → 109€
                'price_period' => 'year',
                'features' => [
                    'transcription' => true,
                    'ai_description' => true,
                ...
                'description' => '600 crediti/anno (50/mese). Perfetto per canali in crescita. Risparmi 1 mese!',
                'is_active' => true,
                'sort_order' => 2,
            ],
            
            // ========================================
            // PIANO 3: PROFESSIONAL ANNUALE
            // Mensile: 29.99€ × 11 = 329.89€ → 329€/anno
            // Crediti: 100/mese × 12 = 1200/anno
            // ========================================
            'professional' => [
                'name' => 'Professional',
                'slug' => 'professional',
                'credits' => 1200, // 100/mese × 12 mesi
                'credits_period' => 'year',
                'activations' => 3,
                'price' => 329.00, // 29.99 × 11 = 329.89 → 329€
                'price_period' => 'year',
                'features' => [
                    'transcription' => true,
                    'ai_description' => true,
                ...
                'description' => '1200 crediti/anno (100/mese). Per creator professionisti. Risparmi 1 mese!',
                'is_active' => true,
                'sort_order' => 3,
            ],
            
            // ========================================
            // PIANO 4: BUSINESS ANNUALE
            // Mensile: 79.99€ × 11 = 879.89€ → 879€/anno
            // Crediti: 500/mese × 12 = 6000/anno
            // ========================================
            'business' => [
                'name' => 'Business',
                'slug' => 'business',
                'credits' => 6000, // 500/mese × 12 mesi
                'credits_period' => 'year',
                'activations' => 10,
                'price' => 879.00, // 79.99 × 11 = 879.89 → 879€
                'price_period' => 'year',
                'features' => [
                    'transcription' => true,
                    'ai_description' => true,
                ...
                'description' => '6000 crediti/anno (500/mese). Per agenzie e team. Risparmi 1 mese!',
                'is_active' => true,
                'sort_order' => 4,
            ],
            
            // ========================================
            // PIANO 5: GOLDEN PROMPT (solo template)
            // Prezzo fisso 59€ - NESSUN credito incluso
            // ========================================
            'golden_prompt' => [
                'name' => 'Golden Prompt',
                'slug' => 'golden_prompt',
                'credits' => 0, // NESSUN credito incluso
                'credits_period' => 'once',
                'activations' => 1,
                'price' => 59.00, // Prezzo fisso
                'price_period' => 'once', // Acquisto singolo
                ...
                'description' => 'Template Premium personalizzato per generare descrizioni YouTube professionali.',
                'is_active' => true,
                'sort_order' => 5,
            ],
            
            // ========================================
            // EXTRA CREDITS: PACCHETTO 10
            // ========================================
            'extra_credits_10' => [
            ...
            'extra_credits_100' => [
                ...
                'credits_period' => 'once', // Non scadono mai
                'activations' => 0, // Non richiede attivazione
                'price' => 45.00, // 0.45€/credito (sconto quantità)
                'price_period' => 'once',
                'features' => [
                    'transcription' => true,
                    'ai_description' => true,
                ...
                'description' => '100 crediti extra (0,45€/credito). Non scadono mai. Sconto quantità!',
                'is_active' => true,
                'sort_order' => 7,
            ],
        ];
