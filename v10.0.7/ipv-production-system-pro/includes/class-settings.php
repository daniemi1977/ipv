...
class IPV_Prod_Settings {
    ...
    public static function render_page() {
        ...
        // License status
        $is_licensed = class_exists( 'IPV_Prod_API_Client' ) ? IPV_Prod_API_Client::is_license_active() : false;
        ...
        <div class="wrap ipv-prod-wrap">
            ...
            <ul class="nav nav-tabs mb-4" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo esc_url( admin_url( 'edit.php?post_type=ipv_video&page=ipv-production-import' ) ); ?>">
                        <i class="bi bi-upload me-1"></i><?php esc_html_e( 'Import', 'ipv-production-system-pro' ); ?>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active" href="<?php echo esc_url( admin_url( 'edit.php?post_type=ipv_video&page=ipv-production-settings' ) ); ?>">
            ...
            <form method="post" action="<?php echo esc_url( admin_url( 'edit.php?post_type=ipv_video&page=ipv-production-settings' ) ); ?>" class="ipv-form">
