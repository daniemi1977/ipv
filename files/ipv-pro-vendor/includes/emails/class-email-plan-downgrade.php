<?php
/**
 * IPV Email - Plan Downgrade
 *
 * Email inviata quando un utente fa downgrade del piano
 */

if ( ! defined( 'ABSPATH' ) ) exit;

class IPV_Email_Plan_Downgrade extends WC_Email {
    ...
    public function __construct() {
        $this->id             = 'ipv_plan_downgrade';
        $this->title          = __( 'IPV - Downgrade Piano', 'ipv-pro-vendor' );
        $this->description    = __( 'Email inviata quando un cliente fa downgrade del piano IPV Pro.', 'ipv-pro-vendor' );
        $this->template_base  = IPV_VENDOR_PATH . 'templates/';
        $this->template_html  = 'emails/plan-downgrade.php';
        $this->template_plain = 'emails/plain/plan-downgrade.php';
        $this->placeholders   = [
            '{customer_name}' => '',
            '{old_plan}'      => '',
            '{new_plan}'      => '',
        ...
        add_action( 'ipv_send_plan_downgrade_email', [ $this, 'trigger' ], 10, 3 );
    ...
    public function get_default_subject() {
        return __( 'Piano modificato: Ora sei su {new_plan}', 'ipv-pro-vendor' );
    }

    public function get_default_heading() {
        return __( 'Il tuo piano IPV Pro è stato modificato', 'ipv-pro-vendor' );
    }
